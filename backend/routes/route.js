...
let {add,login, updpwd, getd}=require("../controller/usercon")
let {addpost, getpost, getby, updpost, del}=require("../controller/pcon")
const { getw, addw} = require("../controller/wcon")
